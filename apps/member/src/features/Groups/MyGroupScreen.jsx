...
export default function MyGroupScreen({ user }) {
    ...
    return (
      <main className="min-h-screen bg-slate-50 p-6">
        <div className="max-w-lg mx-auto">
          <button onClick={() => navigate(-1)} className="text-sm text-slate-500 hover:text-slate-700 mb-3">
            ← Back
          </button>
  ...
  return (
    <main className="min-h-screen bg-slate-50 pb-12">
      <header className="bg-white border-b border-slate-200 px-4 py-4">
        ...
        <h1 className="text-lg font-semibold text-slate-900">My Group</h1>
        <p className="text-xs text-slate-400 mt-0.5">Group summary</p>
      </header>

      <div className="max-w-lg mx-auto px-4 pt-6 space-y-4">
        <section className="bg-white rounded-2xl border border-slate-200 shadow-sm px-5 py-4 space-y-3">
          <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide">Group Details</p>
